<template>
    <div class="masonry" ref="wrapper" @click="setCount" :style="'column-count':count">
...
export default {
    ...
    // computed:{
    //     wrapperWidth() {
    //         let n = this.$refs.wrapper.offsetHeight;
    //         console.log(n)
    //         debugger;
    //         return n;
    //     }
    ...
    methods:{
        className (index){
            ...
            return 'item__content item__content--' + ext[Math.floor(Math.random()*3)]
        },
        setCount(){
